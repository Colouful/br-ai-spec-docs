...
- `br-ai-spec-visual`：可视化展示与治理层，负责汇总和展示已同步 / 已上报的运行结果
...
3. `br-ai-spec-visual` 数据库中的 `RegistryItem`
4. `br-ai-spec-visual` 的本地文件 fallback（仅无数据库结果时使用）
...
```text
Collector / Hook / Receipt -> br-ai-spec-visual ingest
...
3. 在目标项目中执行真实 run
4. 用 `br-ai-spec-visual` 查看工作台、门禁和治理结果
...
- Visual 仓文档：[与 br-ai-spec 协作与技术栈](../../../br-ai-spec-visual/docs/与%20br-ai-spec%20协作与技术栈.md)
